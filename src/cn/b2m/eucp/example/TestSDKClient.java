...
public class TestSDKClient {
	public static String softwareSerialNo = "0SDK-EBB-0130-JIUMN";// 软件序列号,请通过亿美销售人员获取
	public static String key = "503497";// 序列号首次激活时自己设定
	public static String password = "503497";// 密码,请通过亿美销售人员获取
	...
	public static void testSendSMS() {
		try {
			int i = SingletonClient.getClient().sendSMS(new String[] { "17801020569" }, "【大田集团资源供应链管理平台】验证码为XXXX", "",5);// 带扩展码
	...
	*/
	...
	public static void testRegistDetailInfo() {
		try {
			...
			int a = SingletonClient.getClient().registDetailInfo("交大大田集团", "交大郝晨栋", "01059237976",
					"18401608330", "chendonghao_cn@163.com", "01059237684", "北京交通大学", "100044");
	...
	public static void testSerialPwdUpd() {
		try {
			int a = SingletonClient.getClient().serialPwdUpd("503497", password);
