...
CREATE TABLE `warehouse` (
  ...
  `remainArea` float(10,0) DEFAULT NULL,
  ...
  `phone` varchar(255) DEFAULT NULL,
  `detailPrice` varchar(255) DEFAULT NULL,
  `standPrice` float(10,0) DEFAULT NULL,
  `remarks` varchar(255) DEFAULT NULL,
  `carrierId` varchar(255) DEFAULT NULL,
  `relDate` date DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `warehouse` VALUES ('RE00000001', '1号库', '北京', '北京市海淀区', '保税', '自有', '20000', '1000', '6000', '6', '乙', '露天', '烟感', 'Internet宽带接入', '机械出入库搬运', '张三', '13900003366', '/usr/local/iver99/testfile.txt', '23', '无', 'CL29101095', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000002', '22号库', '上海', '上海市浦东区', '保税', '自有', '10000', '123', '6000', '5', '甲', '冷藏', '烟感', 'Internet宽带接入', '机械出入库搬运', '孙武', '13900003367', '/usr/local/iver99/testfile.txt', '1123', '无', 'CL29101095', '2015-05-31');
INSERT INTO `warehouse` VALUES ('RE00000003', '3号库', '北京', '北京市朝阳区', '保税', '自有', '10000', '123', '6000', '4', '甲', '冷藏', '24小时摄像监控', '仓库信息管理系统', '分拣', '孙亮', '13900003368', '/usr/local/iver99/testfile.txt', '12', '', 'CL29101095', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000004', '4号库', '天津', '天津市西青区', '保税', '自有', '30000', '123', '8000', '8', '乙', '露天', '烟感, 24小时摄像监控', '仓库信息管理系统', '机械出入库搬运', '王楠', '13925456563', '/usr/local/iver99/testfile.txt', '123', '', 'CL29101095', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000005', '55号库', '广州', '广州市天河区', '保税', '自有', '20000', '2343', '6000', '6', '丙', '冷藏', '24小时摄像监控', '仓库信息管理系统', '分拣', '李四', '13845478789', '/usr/local/iver99/testfile.txt', '5435', '', 'CL29101095', '2015-05-30');
INSERT INTO `warehouse` VALUES ('RE00000006', '林安库', '广州', '广州市林安区', '保税', '自有', '50000', null, '5000', '5', '甲', '冷藏', '烟感, 24小时摄像监控', 'Internet宽带接入', '分拣, 包装', '陈泽', '15621545698', '/usr/local/iver99/testfile.txt', null, '', 'CL29101095', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000007', '浦西库', '上海', '上海市浦西区', '非保税', '自有', '40000', null, '6000', '6', '甲', '恒温', '烟感, 24小时摄像监控', '信息系统', '机械出入库搬运', '王铎', '16565323656', '/usr/local/iver99/testfile.txt', null, '', 'CL29101095', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000008', '西青库', '天津', '天津市西青区', '保税', '自有', '60000', null, '8000', '8', '丙', '普通', '烟感, 24小时摄像监控', '仓库信息管理系统', '分拣, 包装', '李萍', '15545236569', '/usr/local/iver99/testfile.txt', null, '', 'CL41403136', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000009', '海淀库', '北京', '北京市海淀区', '非保税', '自有', '20000', null, '4000', '4', '乙', '冷藏', '烟感, 24小时摄像监控', '信息系统', '分拣, 包装', '陈楠', '19656523256', '/usr/local/iver99/testfile.txt', null, '', 'CL41403136', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000010', '河西库', '天津', '天津市河西区', '非保税', '自有', '10000', null, '5000', '4', '甲', '冷藏', '烟感, 24小时摄像监控', '信息系统', '机械出入库搬运', '王伟', '12656532323', '/usr/local/iver99/testfile.txt', null, '', 'CL41403136', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000011', '501库', '天津', '天津市西青区', '保税', '自有', '30000', null, '6000', '5', '甲', '冷藏', '烟感, 24小时摄像监控', '仓库信息管理系统', '分拣, 包装', '李毅', '15645423569', '/usr/local/iver99/testfile.txt', null, '', 'CL41403136', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000012', '502库', '上海', '上海市浦东区', '保税', '自有', '30000', null, '8000', '6', '甲', '露天', '烟感, 24小时摄像监控', 'Internet宽带接入', '机械出入库搬运', '陈伟', '17565498653', '/usr/local/iver99/testfile.txt', null, '', 'CL73207711', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000013', '503库', '青岛', '青岛市', '非保税', '租赁', '10000', null, '4000', '3', '丙', '冷藏', '24小时摄像监控', 'Internet宽带接入', '分拣', '孙楠', '16632569874', '/usr/local/iver99/testfile.txt', null, '', 'CL73207711', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000014', '504库', '广州', '广州市林安区', '非保税', '租赁', '20000', null, '5000', '4', '乙', '冷藏', '烟感, 24小时摄像监控', '信息系统', '分拣, 包装', '孙成', '14523265654', '/usr/local/iver99/testfile.txt', null, '', 'CL73207711', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000015', '505库', '南京', '南京市', '保税', '自有', '50000', null, '6000', '8', '甲', '露天', '烟感, 24小时摄像监控', '仓库信息管理系统', '机械出入库搬运', '李平', '12545456365', '/usr/local/iver99/testfile.txt', null, '', 'CL73207711', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000016', '西青A库', '天津', '天津市西青区', '保税', '自有', '20000', null, '5000', '6', '甲', '冷藏', '烟感, 24小时摄像监控', '仓库信息管理系统', '分拣, 包装', '陈增', '12354565569', '/usr/local/iver99/testfile.txt', null, '', 'CL73207711', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000017', '河西A库', '天津', '天津市河西区', '非保税', '租赁', '10000', null, '3000', '3', '丙', '冷藏', '24小时摄像监控', 'Internet宽带接入', '分拣', '陈平', '15845423265', '/usr/local/iver99/testfile.txt', null, '', 'CL73207711', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000018', '朝阳A库', '北京', '北京市朝阳区', '非保税', '自有', '30000', null, '5000', '4', '乙', '恒温', '烟感, 24小时摄像监控', '信息系统', '分拣, 包装', '王五', '15698654541', '/usr/local/iver99/testfile.txt', null, '', 'CL73207711', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000019', '机场A库', '北京', '北京市朝阳区', '保税', '自有', '50000', null, '6000', '8', '甲', '普通', '烟感, 24小时摄像监控', '仓库信息管理系统', '机械出入库搬运', '李德', '16898956565', '/usr/local/iver99/testfile.txt', null, '', 'CL41403136', '2015-05-20');
INSERT INTO `warehouse` VALUES ('RE00000020', '西青B库', '天津', '天津市西青区', '非保税', '自有', '30000', null, '6000', '6', '甲', '冷藏', '烟感, 24小时摄像监控', '仓库信息管理系统', '分拣, 包装', '陈怡', '14545254566', '/usr/local/iver99/testfile.txt', null, '', 'CL41403136', '2015-05-20');
