...
CREATE TABLE `truck` (
  ...
  `onwayTime` int(11) DEFAULT NULL,
  `carType` varchar(255) DEFAULT NULL,
  `carLength` float(10,0) DEFAULT NULL,
  `stanPrice1` float(10,0) DEFAULT NULL,
  `stanPrice2` float(10,0) DEFAULT NULL,
  `pickFee` float(10,0) DEFAULT NULL,
  `deliveryFee` float(10,0) DEFAULT NULL,
