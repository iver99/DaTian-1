...
<div id="main_frame">
	...
	<form id="changephone" action="changephone" method="post">
		...
		<tr>
            ...
            <td class="td_leftnav_top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right2a">
					<tr>
                    	<td>
                        	<span class="span_mgmt_right2_text1">绑定新手机号</span>
					...
					<tr>
						<td class="td_mgmt_right3_td1a"> 
							...
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="120" height="40" class="td_mgmt_right3_td1b">新手机号：</td>
									<td><input type="text" id="phone" name="phone" class="input_mgmt1" style="width:176px;"/></td>
									<td><input type="hidden" id="hideparam" /></td>
								</tr>
								<tr>
									<td height="40" class="td_mgmt_right3_td1b">手机验证码：</td>
									<td>
                                        <input type="text" class="input_mgmt1" id="validationkey" style="width:86px;" />
                    					...
                    					document.getElementById("btn_t").onclick=function(){
								...
								<tr>
									...
									<td><input type="button" id="btn1" value="提交" class="btn_mgmt1" hidefocus="true" onclick="validationCheck();" />
									<input type="button" id="reset" value="重填" class="btn_mgmt2" hidefocus="true" /></td>
								</tr>
							</table>
						</td>
					</tr>
