		...
		<tr>
            ...
            <td class="td_leftnav_top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right2a">
					<tr>
                    	<td>
                        	<span class="span_mgmt_right2_text1">查看客户信息</span>
					...
					<tr>
						...
						<br />   	          
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="120" height="40" class="td_mgmt_right3_td1b">客户帐号：</td>
                                    <td>${clientInfo.account }</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>${clientInfo.clientBusiness }</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><a href="downloadclientrelated?id=${clientInfo.id }" hidefocus="true"><img src="images/btn_filetype2.png" /></a></td>
                                </tr>
                                <tr>
