    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td width="230" class="td_leftnav_top">
				...
				<form action="confirmResponse?responseid=${responseinfo.id }&carrierid=${responseinfo.carrierId}&goodsid=${responseinfo.goodsId}" method="post">
 					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right2a">
                    <tr>
                        <td>
                            <span class="span_mgmt_right2_text1">反馈确认</span>
                        ...
                        <td class="td_mgmt_right3_td1a">
                            ...
                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><a href="downloadResponseMaterial?responseid=${responseinfo.id }" hidefocus="true"><img src="images/btn_filetype2.png" /></a></td>
                                </tr>
                                <tr>
                                    <td height="40" class="td_mgmt_right3_td1b">备注：</td>
                                    <td>${responseinfo.remarks }</td>
                                </tr>
                                <tr>
                                    <td height="40" class="td_mgmt_right3_td1b">&nbsp;</td>
                                    <td><input type="submit" id="btn1" value="确认并提交订单" class="btn_mgmt1" hidefocus="true"  style="width:120px;" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
