		...
		<tr>
			...
			<td class="td_leftnav_top">
            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right2">
                    <tr>
                    	<td>
                        	<span class="span_mgmt_right2_text1">司机信息</span>
                            <span class="span_mgmt_right2_text2"><a href="insert?flag=5" hidefocus="true"><img src="images/btn_add1.png" class="span_mgmt_right2_pic1" title="添加" /></a></span>
                        </td>
                	</tr>
				</table>
...
<script type="text/javascript">
	...
	//加载司机资源
	function getUserDriverResource(display,currentPage){
		var url="getUserDriverResourceAjax";
		$.ajax({
			url:url,
			data:{
				display:display,
	...
	//司机资源总条数
	function getUserDriverResourceTotalRows(display,currentPage){
		var url="getUserDriverResourceTotalRowsAjax";
		$.ajax({
			url:url,
			data:{
				display:display,
