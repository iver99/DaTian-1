		...
		<tr>
                ...
                <div id="main_frame_left" >
                    ...
                    <div id="mgmt_nav2" >
                     <% if((Integer)session.getAttribute("userKind") ==3) {%>
                        ...
                        <a href="lesstruckload?flag=1" class="a_mgmt_leftnav1" hidefocus="true">零担资源信息</a>
			...
			<td class="td_leftnav_top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right2a">
                    <tr>
                        <td>
                            <span class="span_mgmt_right2_text1">更新零担资源信息</span>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right3">
                    <tr>
                        <td class="td_mgmt_right3_td1a"> 
                            ...
                            <form action="updatelesstruckload?id=${truckInfo.id }" method="post" enctype="multipart/form-data">	          
                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td height="40" class="td_mgmt_right3_td1b">始发城市：</td>
                                    <td id="cityselector"><input id="city1" type="text" value="${truckInfo.startCity }" class="input_city1" name="startCity" required/></td>
                                </tr>
                                <tr>
                                    <td height="40" class="td_mgmt_right3_td1b">到达城市：</td>
                                    <td id="cityselector"><input id="city2" type="text" value="${truckInfo.endCity }" class="input_city1" name="endCity" required/></td>
                                </tr>
                                <tr>
                                    <td height="40" class="td_mgmt_right3_td1b">运输时限：</td>
                                    <td><input type="text" class="input_mgmt1" name="onwayTime" value="${truckInfo.onwayTime }" id="onwaytime" style="width:300px;" required/>
                                    (小时)</td>
                                </tr>
                                <tr>
                               ...
                               <tr>
                                    ...
                                    <td><input type="text" name="stanPrice1" value="${truckInfo.stanPrice1 }" class="input_mgmt1" style="width:112px;" required/>
                                    (元/吨)</td>
                                </tr>
                                <tr>
                                    <td height="40" class="td_mgmt_right3_td1b">标准报价：</td>
                                    <td><input type="text" name="stanPrice2" value="${truckInfo.stanPrice2 }" class="input_mgmt1" style="width:112px;" required/>
                                    (元/方)</td>
                                </tr>
                                <tr>
                                    <td height="40" class="td_mgmt_right3_td1b">提货费：</td>
                                    <td><input type="text" name="pickFee" value="${truckInfo.pickFee }" class="input_mgmt1" style="width:112px;" required/>
                                    (元)</td>
                                </tr>
                                <tr>
                                    <td height="40" class="td_mgmt_right3_td1b">送货费：</td>
                                    <td><input type="text" name="deliveryFee" value="${truckInfo.deliveryFee }" class="input_mgmt1" style="width:112px;" required/>
                                    (元)</td>
                                </tr>
								<tr>
								...
								<tr>
									...
									<td>
                                    	<textarea class="textarea_rating" id="remarks" placeholder="请输入内容..." name="remarks" >${truckInfo.remarks }</textarea>
                                    </td>
								</tr>
                                <tr>
