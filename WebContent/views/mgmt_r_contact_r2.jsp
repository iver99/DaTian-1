		...
		<tr>
            ...
            <td class="td_leftnav_top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right2a">
                    <tr>
                        <td>
                            <span class="span_mgmt_right2_text1">确认合同</span>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right3">
                    <tr>
                        ...
                        <br />   	          
                        <form action="confirmcontract?id=${contract.id }" method="post">
                        <table width="90%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td><input type="submit" id="btn1" value="确认" class="btn_mgmt1" hidefocus="true" onclick="window.location.href='mgmt_r_contact_r.htm'" /></td>
                            </tr>
                        </table>
                        </form>
                    </td>
