                        ...
                        <td class="td_mgmt_right3_td1a"> 
                            ...
                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
									...
									<td>
                                    	<textarea class="textarea_rating" placeholder="请输入内容..." name="goodsDes" required>${goodsdetail.goodsDes }</textarea>
                                    </td>
								</tr>
                                <tr>
									<td height="40" class="td_mgmt_right3_td1b">运输要求：</td>
									<td>
                                    	<textarea class="textarea_rating" placeholder="请输入内容..." name="transportReq" required>${goodsdetail.transportReq }</textarea>
                                    </td>
								</tr>
                                <tr>
									<td height="40" class="td_mgmt_right3_td1b">费用要求：</td>
									<td>
                                    	<textarea class="textarea_rating" placeholder="请输入内容..." name="feeReq" required>${goodsdetail.feeReq }</textarea>
                                    </td>
								</tr>
                                <tr>
